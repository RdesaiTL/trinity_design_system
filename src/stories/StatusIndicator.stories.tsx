    ...
    <Stack spacing={3}>
      ...
      <Box>
        ...
        <Typography variant="caption" color="text.secondary" display="block" sx={{ mb: 1 }}>
          Demonstrates custom color override capability for specific branding needs.
        </Typography>
        <Stack direction="row" spacing={4}>
          {/* @intentional-color: Demo of custom color override API for differential indicators */}
          <StatusIndicator 
